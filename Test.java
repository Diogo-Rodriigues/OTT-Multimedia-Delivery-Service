     ...
     class serverTimerListener implements ActionListener {
       ...
       try {
         ...
         int image_length = video.getnextframe(sBuf);
          ...
          byte[] dummySource = new byte[4]; // Dummy source for test
          RTPpacket rtp_packet = new RTPpacket(MJPEG_TYPE, imagenb, imagenb*FRAME_PERIOD, sBuf, image_length, dummySource);
